#!/bin/bash
# PCL MUSA Build Script - GPU Migration Test
set -e
...
echo "============================================"
echo "  PCL MUSA GPU Migration Build Test"
echo "============================================"
...
echo ""
echo "=== Step 2: Configure CMake with GPU modules ==="
...
echo ""
echo "=== Step 3: Compile GPU modules ==="
make -j$(nproc) pcl_gpu_containers pcl_gpu_utils pcl_gpu_octree pcl_gpu_features pcl_gpu_segmentation 2>&1 | tail -50
